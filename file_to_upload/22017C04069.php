...
<head>
    ...
    <link rel="shortcut icon" href="https://www.pngwing.com/en/free-png-hoxfb/download" type="image/x-icon">
    <link rel="icon" href="https://www.pngwing.com/en/free-png-hoxfb/download" type="image/x-icon">
...
<body>
    ...
    <footer class="text-center bg-warning-subtle mt-4">
        ...
        <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.05);">
            © 2024 :
            <a class="text-body" href="https://www.polygwalior.ac.in">Dr. B.R. Ambedkar Polytechnic, College</a> 
        </div>
    </footer>
    ...
    <script>
        ...
        let headTitle = document.head.querySelectorAll("title")[0].innerText;
        setInterval(()=>{
            const now = new Date();
